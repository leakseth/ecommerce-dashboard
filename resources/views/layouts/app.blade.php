        ...
        <nav>
          <ul class="nav flex-column">
            <li class="nav-item mb-2">
              <a href="{{ route('dashboard') }}" class="nav-link text-black {{ request()->is('admin/dashboard') ? 'active' : '' }}">
                <i class="bi bi-house-door me-2"></i>Dashboard
              </a>
            </li>
            <li class="nav-item mb-2">
              <a href="{{ route('products.index') }}" class="nav-link text-black {{ request()->is('admin/products') ? 'active' : '' }}">
                <i class="bi bi-box-seam me-2"></i>Product
              </a>
            </li>
            <li class="nav-item mb-2">
              <a href="{{ route('category.index') }}" class="nav-link text-black {{ request()->is('admin/categories') ? 'active' : '' }}">
                <i class="bi bi-bookmark-check me-2"></i>Category
              </a>
            </li>
            <li class="nav-item mb-2">
              <a href="{{ route('user.index') }}" class="nav-link text-black {{ request()->is('admin/users') ? 'active' : '' }}">
            ...
            <li class="nav-item mb-2">
              <a href="{{ route('settings') }}" class="nav-link text-black {{ request()->is('admin/settings') ? 'active' : '' }}">
